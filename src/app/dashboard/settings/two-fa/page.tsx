        ...
        <div className="w-full max-w-2xl">
          ...
          <div className="mb-8">
            <Link
              ...
              className="inline-flex items-center text-xl gap-2 text-[#ACB5BB] hover:text-white transition-colors mb-4"
            >
              <ArrowLeftIcon />
              Back to Settings
            </Link>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3 p-4 bg-[#232326] rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-[#ACB5BB] text-lg mb-3">Choose one of these authenticator apps:</p>
                    <div className="space-y-2">
                      <a 
                        href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2" 
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="block text-[#9945FF] hover:text-[#0BCB7B] transition-colors text-base underline"
                      >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60 p-4">
          <div className="bg-[#161618] border border-[#2C2C30] rounded-2xl p-8 w-full max-w-md relative">
            ...
            <div className="text-center mb-6">
              <h3 className="text-4xl font-bold text-white mb-2">Scan QR Code</h3>
              <p className="text-[#ACB5BB] text-xl">
            ...
            <div className="bg-[#232326] rounded-xl p-4 mb-6">
              <h4 className="text-white text-xl font-medium mb-2">Can't scan? Enter this code manually:</h4>
              <div className="flex items-center gap-2">
                <code className=" text-[#19F12F] px-3 py-2 rounded text-base font-mono flex-1 break-all">
                  {totpSecret}
                </code>
                <button
                  onClick={() => copyToClipboard(totpSecret)}
                  className="p-2 text-[#ACB5BB] hover:text-[#9945FF] transition-colors flex-shrink-0"
                >
                  <CopyIcon />
                </button>
              </div>
