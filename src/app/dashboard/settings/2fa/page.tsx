        ...
        <div className="w-full max-w-2xl">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center gap-3 mb-2">
              <ShieldIcon />
              <h1 className="text-6xl font-bold bg-gradient-to-r from-[#9945FF] to-[#0BCB7B] bg-clip-text text-transparent">
          ...
          {step === 'setup' && (
            <div className="bg-[#161618] border border-[#2C2C30] rounded-2xl p-8">
              <div className="text-center mb-8">
                ...
                <h2 className="text-4xl font-bold text-white mb-4">Enable Two-Factor Authentication</h2>
                <p className="text-[#ACB5BB] text-xl">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3 p-4 bg-[#232326] rounded-xl">
                  ...
                  <div>
                    <h3 className="text-white text-xl font-medium">Download an authenticator app</h3>
                    <p className="text-[#ACB5BB] text-lg">Google Authenticator, Authy, or Microsoft Authenticator</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-4 bg-[#232326] rounded-xl">
                  ...
                  <div>
                    <h3 className="text-white text-xl font-medium">Scan QR code</h3>
                    <p className="text-[#ACB5BB] text-lg">Use your authenticator app to scan the QR code</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-4 bg-[#232326] rounded-xl">
                  ...
                  <div>
                    <h3 className="text-white text-xl font-medium">Enter verification code</h3>
                    <p className="text-[#ACB5BB] text-lg">Complete setup by entering the 6-digit code</p>
                  </div>
                </div>
              </div>
              ...
              <button
                ...
                disabled={loading}
                className="w-full py-4 px-6 bg-gradient-to-r from-[#9945FF] to-[#0BCB7B] text-white text-lg rounded-xl font-medium hover:shadow-lg hover:shadow-purple-500/20 transition-all disabled:opacity-50"
              >
          ...
          {step === 'verify' && (
            <div className="bg-[#161618] border border-[#2C2C30] rounded-2xl p-8">
              <div className="text-center mb-8">
                <h2 className="text-4xl font-bold text-white mb-4">Scan QR Code</h2>
                <p className="text-[#ACB5BB] text-xl">
              ...
              <div className="bg-[#232326] rounded-xl p-4 mb-8">
                <h3 className="text-white text-xl font-medium mb-2">Can't scan? Enter this code manually:</h3>
              ...
              <div className="space-y-4">
                <div>
                  <label className="text-white font-medium text-2xl block mb-2">Enter verification code</label>
                  <input
                    type="text"
                    placeholder="000000"
                    maxLength={6}
                ...
                <div className="flex gap-4">
                  <button
                    ...
                    className="flex-1 py-4 px-6 bg-[#232326] text-white text-lg rounded-xl font-medium hover:bg-[#2C2C30] transition-all"
                  >
                    Back
                  </button>
                  <button
                    ...
                    className="flex-1 py-4 px-6 bg-gradient-to-r from-[#9945FF] to-[#0BCB7B] text-white text-lg rounded-xl font-medium hover:shadow-lg hover:shadow-purple-500/20 transition-all disabled:opacity-50"
                  >
          ...
          {step === 'backup' && (
            <div className="bg-[#161618] border border-[#2C2C30] rounded-2xl p-8">
              <div className="text-center mb-8">
                ...
                <h2 className="text-4xl font-bold text-white mb-4">2FA Enabled Successfully!</h2>
                <p className="text-[#ACB5BB] text-xl">
              ...
              <div className="bg-[#232326] rounded-xl p-6 mb-8">
                ...
                <button
                  ...
                  className="w-full py-3 px-4 bg-[#44444A] text-white text-lg rounded-lg hover:bg-[#555] transition-all flex items-center justify-center gap-2"
                >
                  <CopyIcon />
                  Copy All Codes
                </button>
              ...
              <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-4 mb-8">
                <h4 className="text-red-400 text-xl font-medium mb-2">⚠️ Important:</h4>
                <ul className="text-red-300 text-lg space-y-1">
              ...
              <button
                onClick={finishSetup}
                className="w-full py-4 px-6 bg-gradient-to-r from-[#9945FF] to-[#0BCB7B] text-white text-lg rounded-xl font-medium hover:shadow-lg hover:shadow-purple-500/20 transition-all"
              >
                Complete Setup
              </button>
            </div>
          ...
          {step === 'manage' && is2FAEnabled && (
            <div className="bg-[#161618] border border-[#2C2C30] rounded-2xl p-8">
              <div className="text-center mb-8">
                ...
                <h2 className="text-4xl font-bold text-white mb-4">2FA is Active</h2>
                <p className="text-[#ACB5BB] text-xl">
              ...
              <div className="space-y-4 mb-8">
                <div className="bg-[#232326] rounded-xl p-6">
                  <h3 className="text-white text-xl font-medium mb-2">Status</h3>
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 bg-[#19F12F] rounded-full"></div>
                    <span className="text-[#19F12F] text-lg">Two-Factor Authentication Enabled</span>
                  </div>
                </div>

                <div className="bg-[#232326] rounded-xl p-6">
                  <h3 className="text-white text-xl font-medium mb-2">Recovery Options</h3>
                  <p className="text-[#ACB5BB] text-lg mb-4">
                    Make sure you have access to your authenticator app and backup codes.
                  </p>
                  <button
                    onClick={() => toast.success("Feature coming soon")}
                    className="py-2 px-4 bg-[#44444A] text-white text-lg rounded-lg hover:bg-[#555] transition-all"
                  >
                    View Backup Codes
                  </button>
                </div>
              ...
              <div className="flex gap-4">
                <Link
                  href="/dashboard/settings"
                  className="flex-1 py-4 px-6 bg-[#232326] text-white text-lg rounded-xl font-medium hover:bg-[#2C2C30] transition-all text-center"
                >
                  Back to Settings
                </Link>
                <button
                  onClick={disable2FA}
                  disabled={loading}
                  className="flex-1 py-4 px-6 bg-red-500 text-white text-lg rounded-xl font-medium hover:bg-red-600 transition-all disabled:opacity-50"
                >
