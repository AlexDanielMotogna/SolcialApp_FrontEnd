      ...
      <div className="flex-1 flex flex-col items-center w-full px-6 py-8">
        <div className="w-full max-w-4xl">
          ...
          <div className="space-y-6">
            ...
            {/* Security Section */}
            <section className="bg-[#161618] border border-[#2C2C30] rounded-2xl p-6">
              ...
              <div className="space-y-4">
                <Link
                  ...
                  className="flex items-center justify-between p-4 bg-[#232326] hover:bg-[#2C2C30] rounded-xl transition-all duration-200 group"
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[#ACB5BB] text-sm">Update your account password</p>
                    </div>
                  </div>
                  <ChevronRightIcon />
                </Link>
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className="w-10 h-10 bg-[#0BCB7B]/10 rounded-lg flex items-center justify-center">
                      <ShieldIcon />
                    </div>
                    <div>
            ...
            <section className="bg-[#161618] border border-[#2C2C30] rounded-2xl p-6">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-between p-4 bg-[#232326] hover:bg-[#2C2C30] rounded-xl transition-all duration-200 group"
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-[#ACB5BB] text-sm">Sign out of your account</p>
                    </div>
                  </div>
                  <ChevronRightIcon />
                </button>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-between p-4 bg-red-500/5 hover:bg-red-500/10 border border-red-500/20 rounded-xl transition-all duration-200 group"
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-[#ACB5BB] text-sm">Permanently delete your account</p>
                    </div>
                  </div>
                  <ChevronRightIcon />
                </button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="bg-[#161618] border border-[#44444A] rounded-2xl shadow-2xl p-8 flex flex-col items-center gap-6 w-[400px] mx-4">
            ...
            <div className="text-center">
              <h2 className="text-red-400 text-2xl font-semibold mb-2">Delete Account</h2>
              <p className="text-[#ACB5BB] leading-relaxed">
                Are you sure you want to delete your account? This action cannot be undone and will permanently remove all your data.
              </p>
            </div>
            <div className="flex gap-3 w-full">
              <button
                className="flex-1 px-6 py-3 rounded-xl bg-[#232326] text-white font-medium hover:bg-[#2C2C30] transition"
              ...
              <button
                className="flex-1 px-6 py-3 rounded-xl bg-red-600 text-white font-medium hover:bg-red-700 transition disabled:opacity-50"
