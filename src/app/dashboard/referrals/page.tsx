    ...
    <div className="w-full py-[1.8rem] px-[2.4rem] flex flex-col items-start justify-start gap-[2.4rem]">
      <div className="w-full flex flex-col md:flex-row md:gap-8 items-center justify-between">
        <div className="w-full flex flex-col items-start justify-start gap-1">
          <h2 className="text-white font-semibold text-[2.4rem]">Referrals</h2>
        ...
        <div className="flex items-center justify-center gap-5">
          <div className="w-[160px] md:w-[196px] flex items-center justify-start gap-3 py-[1.4rem] px-4 bg-[#1E1E20] border border-[#2C2C30] rounded-2xl">
            <Image src={HeroHelmet} alt=""/>
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-[1.8rem]">
        <div className="w-full bg-[#1E1E20] border border-[#2C2C30] rounded-2xl p-[1.8rem] flex flex-col items-start justify-start gap-[1.3rem]">
          ...
          <div
            className="w-full bg-[#161618] border border-[#2C2C30] rounded-md flex items-center justify-center shadow-[0px_6px_10px_-3px_rgba(0,0,0,0.25)]"
            style={{
              boxShadow: "inset 0px 7.4px 18.5px 0px rgba(255, 255, 255, 0.1)",
            }}
          >
            <a className="text-white text-[1.4rem] font-semibold py-[1.3rem] cursor-pointer">
