  ...
  return (
    <div className="w-full p-[1.6rem] xl:py-[1.8rem] xl:px-[2.4rem] grid grid-cols-1 xl:grid-cols-3 gap-[1.6rem]">
      <div className="w-full max-h-[790px] bg-[#161618] border border-[#2C2C30] rounded-2xl flex flex-col items-start justify-start overflow-x-hidden">
        ...
        <div
          className="w-full flex flex-col items-start justify-start gap-[0.8rem] px-[1.4rem] pt-[1.4rem] pb-0 overflow-y-auto"
          style={{
            scrollbarWidth: "none",
      ...
      <div className="w-full max-h-[790px] bg-[#161618] border border-[#2C2C30] rounded-2xl flex flex-col items-start justify-start overflow-x-hidden">
        ...
        <div
          className="w-full h-full flex flex-col items-start justify-start gap-[1.6rem] px-[1.4rem] pt-[1.4rem] pb-0  overflow-y-auto"
          style={{
            scrollbarWidth: "none",
            msOverflowStyle: "none",
          }}
        >
          <div className="w-full flex items-center justify-between">
            <div className="p-3 md:p-4 flex flex-wrap flex-shrink-0 items-center justify-center gap-2 md:gap-4 bg-[#2C2C30] border border-[#44444A] rounded-[8px] cursor-pointer">
              <h6 className="text-base md:text-[1.2rem] text-white whitespace-nowrap">Min Cap</h6>
              <ArrowDown />
            </div>
      ...
      <div className="w-full max-h-[790px] overflow-hidden bg-[#161618] border border-[#2C2C30] rounded-2xl flex flex-col items-start justify-start overflow-x-hidden">
        ...
        <div
          className="w-full flex flex-col items-start justify-start gap-[1.6rem] p-[1.4rem] overflow-y-auto"
          style={{
            scrollbarWidth: "none",
            msOverflowStyle: "none",
          }}
        >
          <div className="w-full grid grid-cols-2">
            <div className="w-full flex items-center justify-center border-b-2 border-b-[#7D52F4] p-5">
              <h5 className="text-white text-[1.4rem] font-semibold cursor-pointer whitespace-nowrap">
                Ladder Leaderboard
              </h5>
            </div>
            <div className="w-full flex items-center justify-center p-5">
              <h5 className="text-[#ACB5BB] text-[1.4rem] font-medium cursor-pointer whitespace-nowrap">
