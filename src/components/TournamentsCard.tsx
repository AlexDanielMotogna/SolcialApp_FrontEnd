  ...
  return (
    <div className="w-full p-[1.6rem] bg-[#1E1E20] border border-[#2C2C30] rounded-2xl flex flex-col items-start justify-start gap-4">
      <div className="w-full relative">
        <Image src={Tournament} className="w-full relative" alt="Event" />
        <div className="w-full h-full absolute top-0 right-0 flex flex-col items-center justify-between p-4">
          ...
          <div className="w-full flex items-center justify-center">
            <h6
              className="text-[1.2rem] text-white font-normal bg-[#2C2C30] border border-[#2C2C30] flex items-center justify-center rounded-[5px] py-[0.4rem] px-[0.8rem] shadow-[0px_6px_10px_-3px_rgba(0,0,0,0.25)]"
              style={{
